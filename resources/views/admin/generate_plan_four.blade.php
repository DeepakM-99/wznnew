                                            ...
                                            <td>                
                                                @for ($position = 1; $position <= 4; $position++)
                                                    @php
                                                        ...
                                                        $mealId = $position; 
                                                        $data = isset($structuredData[$week][$dayWithoutPrefix][$mealType][4]) 
                                                                ? $structuredData[$week][$dayWithoutPrefix][$mealType][4] 
                                                                : null;                           
                                                    @endphp    
                                                    <div> 
                                                        <center>
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.error) {
                    ...
                    content += '<input type="hidden" name="meal_id" value="4">'; // Set meal_id to 4
